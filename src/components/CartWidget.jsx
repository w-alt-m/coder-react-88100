    ...
    <div className="dropdown dropdown-end">
      ...
      <div className="card card-compact dropdown-content bg-base-100 z-1 mt-3 w-52 shadow-xl border border-base-200">
        <div className="card-body">
          <span className="text-lg font-bold text-base-content">8 Artículos</span>
          <span className="text-secondary font-semibold">Subtotal: $999</span>
          <div className="card-actions">
            <button className="btn btn-primary btn-block text-white">Ver carrito</button>
          </div>
        </div>
      </div>
    </div>
